...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "radial-ellipse":
          "radial-gradient(circle at center, #E39431, transparent)",
        "custom-gradient":
          "linear-gradient(228deg, #B26B17 0.83%, #4C2E0A 91.82%)",
        "divider-gradient":
          "linear-gradient(#033446 100%, #00BAFF 100%, #00BAFF 100%, #033446 100%)",
        "rank-gradient":
          "linear-gradient(191deg, #033446 60.14%, #067FAC 109.11%)",
        "navbar-gradient": "linear-gradient(360deg, #0F222A 0%, #132B35 100%)",
        "home-gradient":
          "radial-gradient(49.74% 49.75% at 76.71% 35.25%, #1E4759 0%, #020304 100%)",
      },
      boxShadow: {
  ...
  plugins: [
    plugin(function ({ addUtilities }) {
      const radialGradientUtilities = {
        ".radial-gradient": {
          background:
            "radial-gradient(68.4% 68.4% at 51.16% 53.22%, #1E4759 0%, #020304 100%)",
        },
        ".linear-gradient": {
